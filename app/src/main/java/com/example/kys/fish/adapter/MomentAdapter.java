...
//import com.example.kys.fish.model.CommentFun;
//import com.example.kys.fish.model.CustomTagHandler;
//import com.example.kys.fish.model.Moment;
...
//
//    public MomentAdapter(HomeFragment context, ArrayList<Moment> list, CustomTagHandler tagHandler) {
//        mList = list;
//        mContext = context;
...
//        if (convertView == null) {
//            if (position == 0) {
//                convertView = View.inflate(mContext.getActivity(), R.layout.item_header, null);
//            } else {
//                convertView = View.inflate(mContext.getActivity(), R.layout.item_moment, null);
...
//            CommentFun.parseCommentList(mContext.getActivity(), mList.get(index).mComment,
