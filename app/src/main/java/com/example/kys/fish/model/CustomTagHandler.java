...
public class CustomTagHandler implements Html.TagHandler {
    ...
    public CustomTagHandler(final HomeFragment context, final OnCommentClickListener listener) {
       mContext =context;
    ...
    public void handleTag(boolean opening, String tag, final Editable output, XMLReader xmlReader) {
        ...
        if (opening) {
            ...
            if (tag.toLowerCase().equals(TAG_COMMENTATOR)) {
                ...
                output.setSpan(new TextAppearanceSpan(mContext.getActivity(), R.style.Comment),
