...
//         */
//        for (int mI = 0; mI < mComments.size (); mI++) {
//            final Comment mComment = mComments.get (mI);
//            /**
//             * 拼接成“张三：今天天气真好”这种形式，就是一行显示的文本。
//             * 或者为张三 回复 李四：今天天气真好
//             */
//            String mS = null;
//            if (mComment.getSendName() == null || mComment.getReceiversName().equals ("")) {
//                mS = mComment.getSendName() + "：" + mComment.getCommentContent();
//            } else {
//                mS = mComment.getSendName() + mTalkStr +mComment.getReceiversName() + "：" + mComment.getCommentContent();
//            }
//            /**
...
//             */
//            int start = 0;
//            int end = (mComment.getSendName()).length ();
...
//                    if (mListener != null) {
//                        mListener.onNickNameClick (finalMI,mComments.get(finalMI));
//                    }
//                }
//            }, 0, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
//            mString.setSpan (new ForegroundColorSpan(mTalkColor),mComment.getReceiversName().length (),mComment.getReceiversName().length ()+mTalkStr.length (),Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
//
//            /**
//             * 处理第二个人名
//             */
//            if (mComment.getSendName() != null && !mComment.getSendName().equals ("")) {
//                start =mComment.getReceiversName().length () + mTalkStr.length ();
//                end = mComment.getSendName().length () + mTalkStr.length () + mComment.getReceiversName().length ();
//                mString.setSpan (new ClickableSpan () {
//                    @Override
//                    public void updateDrawState (TextPaint ds) {
//                        /**
...
//                        isNickNameClick = true;
//                        if (mListener != null) {
//                            mListener.onToNickNameClick (finalMI,mComments.get(finalMI));
//                        }
//                    }
...
//                    isNickNameClick = true;
//                    if (mListener != null) {
//                        mListener.onCommentItemClick (finalMI,mComments.get(finalMI));
//                    }
//                }
...
//         * @param mComment    评论相关信息
//         */
//        public void onNickNameClick (int position,Comment mComment);
//
//        /**
//         * 点击被评论人名的回调
//         *
...
//         * @param mComment   评论相关信息
//         */
//        public void onToNickNameClick (int position,Comment mComment);
//
//        /**
//         * 点击评论文本回调，主要针对对谁回复操作
//         *
...
//         * @param mComment
//         */
//        public void onCommentItemClick (int position,Comment mComment);
//
//        /**
//         * 点击非文字部分
//         */
